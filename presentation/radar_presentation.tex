...
\begin{frame}{Test 1: O Țintă}
\textbf{Parametri:}
\begin{itemize}
    \item Distanță reală: 5.000 km
...
\textbf{Rezultate:}
\begin{itemize}
    \item \textcolor{green}{Distanță detectată: 4.998 km}
    \item \textcolor{green}{Eroare: 0.04\%}
    \item SNR: 28.5 dB
    \item Beat frequency: 33.3 kHz
\end{itemize}

\begin{alertblock}{Concluzie}
Detecție precisă cu eroare sub 0.1\%!
\end{alertblock}
\end{frame}
