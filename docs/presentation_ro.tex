...
{\tiny \textit{Notă:} excludem o „cruce” (buffer) între cadrane pentru a evita ridge/sidelobe-uri pe axe.}
\end{columns}

\vspace{0em}
{\tiny \textbf{Parametri IPIX:} $N_G = 3$, $N_T = 12$, $P_f = 0.001$}
\end{frame}
...
\begin{itemize}
    \item Sea clutter $\neq$ Gaussian
    \item (heavy tails): valori extreme mai frecvente
