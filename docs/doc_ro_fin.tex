...
Algoritmul original presupune statistică Gaussian/Rayleigh, însă sea clutter real prezintă valori extreme frecvente (spike-uri) și urmează \textbf{K-distribution}:
...
\textbf{Soluție}: Estimare parametru din celulele de training: $\nu = \mu^2 / (\sigma^2 - \mu^2)$. Apoi ajustăm multiplicatorul pragului pentru a reduce alarmele false în clutter cu spike-uri frecvente.
