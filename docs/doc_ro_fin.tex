...
\centering
\vspace{-4pt}
\includegraphics[width=0.42\textwidth]{rqf_vs_snr.pdf}
\hfill
\includegraphics[width=0.42\textwidth]{detection_rate_vs_snr.pdf}
\caption{Performanță vs SNR: RQF și rata detecție 100\% (SNR 5-30 dB).}
