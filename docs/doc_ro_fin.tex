...
\subsection{Pasul 2 Detaliu: Structura CFAR 2D}
...
\textbf{Modificări vs. Paper (Abratkiewicz 2022)}: 
Adaptări pentru sea clutter real: $N_{fft}=256$ (vs. 512), hop=32 (87.5\% overlap), $N_G=3$ (vs. 16), $P_f=0.001$ (vs. 0.4), K-distribution în loc de Gaussian, DBSCAN asimetric (freq\_scale=3.0), DC masking, filtru Doppler. Parametri ușor ajustați pentru IPIX maritime vs. semnale sintetice controlate din paper.
